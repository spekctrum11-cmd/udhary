...
export default function CareerPage() {
  ...
  return (
    <main className="flex-1 bg-surface-container-lowest">
      {/* Hero Section */}
      <section className="bg-deep-navy text-white py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-primary opacity-20 blur-[100px] rounded-full w-full h-[200%] -top-[100%]"></div>
        <div className="max-w-container-max mx-auto px-gutter text-center relative z-10">
          <span className="inline-block px-4 py-1.5 bg-white/10 rounded-full text-label-sm font-label-sm mb-6 uppercase tracking-wider">
            Join Our Team
          </span>
          <h1 className="text-display-lg font-display-lg mb-6 leading-tight">
            Build Your Career with <span className="text-secondary-fixed">Udhary</span>
          </h1>
