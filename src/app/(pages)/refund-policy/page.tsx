    ...
    <main className="flex-1 bg-surface-container-lowest">
      ...
      <section className="bg-surface-blue py-20 border-b border-outline-variant/30">
        <div className="max-w-container-max mx-auto px-gutter text-center">
          <h1 className="text-display-lg font-display-lg text-primary mb-4">Refund <span className="text-secondary">Policy</span></h1>
          <p className="text-body-lg text-on-surface-variant">Clear and transparent policies for our customers.</p>
        </div>
      </section>
