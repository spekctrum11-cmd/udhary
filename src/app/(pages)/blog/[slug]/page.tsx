...
export default async function BlogPostPage(props: { params: Promise<{ slug: string }> }) {
  ...
  const shareUrl = `${process.env.NEXT_PUBLIC_APP_URL || 'https://udhary.onrender.com'}/blog/${blog.slug}`;
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "headline": blog.title,
            "image": [
              `${process.env.NEXT_PUBLIC_APP_URL || 'https://udhary.onrender.com'}${blog.image}`
            ],
            "datePublished": new Date(blog.date).toISOString(),
            "author": [{
              "@type": "Organization",
              "name": "Udhary",
              "url": process.env.NEXT_PUBLIC_APP_URL || "https://udhary.onrender.com"
            }],
            "description": blog.excerpt
          })
        }}
