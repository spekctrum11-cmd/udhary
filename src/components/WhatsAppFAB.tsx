...
export function WhatsAppFAB() {
  return (
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 flex items-center justify-center max-[250px]:hidden">
      ...
      ></div>
      <div
        className="absolute inset-0 rounded-full border-2 border-green-400/50 animate-ping pointer-events-none"
        style={{ animationDuration: '3s', animationDelay: '1s' }}
      ></div>
      <div
        className="absolute inset-0 rounded-full border-2 border-green-300/40 animate-ping pointer-events-none"
      ...
      <a
        ...
        className="relative w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-[0_8px_20px_rgba(34,197,94,0.3)] group"
      >
        {/* Base Gradient */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-green-600 to-green-500 transition-opacity duration-500"></div>

        {/* Hover Glowing Gradient & Shadow */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-emerald-400 to-green-500 opacity-0 group-hover:opacity-100 shadow-[0_0_40px_rgba(52,211,153,0.6)] transition-all duration-500"></div>
